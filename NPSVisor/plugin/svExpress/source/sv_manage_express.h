...
//------------------------------------------------------------------
extern manExpressionVars* allocManVars();
//------------------------------------------------------------------------
...
class svManExpression
{
  public:
    ...
    P_Expr::exprVar getVariable(int id, int offset, int offsByStep, bool& exist);
...
class svExpr : public P_Expression
{
  ...
  protected:
    virtual P_Expr::exprVar getVariable(int id, int offset, int offsByStep, bool& exist)
      {
        return Owner->getVariable(id, offset, offsByStep, exist);
      }
  private:
    svManExpression* Owner;
};
