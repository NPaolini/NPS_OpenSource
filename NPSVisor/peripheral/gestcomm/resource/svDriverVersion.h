#include "svDriverVersionM.h"
#include "svDriverVersionL.h"

#define svFILEVERSION     svVerM1,svVerM2,svVerL1,svVerL2
#define svPRODUCTVERSION  svVerM1,svVerM2,0,0
...
#define svSTRProductVersion svSTR_Make(svVerM1,svVerM2,0,0)
