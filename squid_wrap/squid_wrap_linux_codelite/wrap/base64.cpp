...
{
  for(uint i = 0; i < sizeof(base64_chars); ++i)
...
int base64_encode(char* target, const char* bytes_to_encode, int in_len)
{
  int i = 0, j = 0;
  ...
  *ret = 0;
  return int(ret - target);
}
//----------------------------------------------------------------------------
//std::string base64_decode(std::string const& encoded_string)
int base64_decode(char* target, const char* encoded_string, int in_len)
{
