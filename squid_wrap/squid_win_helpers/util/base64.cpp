...
{
  for(int i = 0; i < sizeof(base64_chars); ++i)
...
int base64_encode(LPSTR target, LPCSTR bytes_to_encode, int in_len)
{
  int i = 0, j = 0;
...
int base64_decode(LPSTR target, LPCSTR encoded_string, int in_len)
{
